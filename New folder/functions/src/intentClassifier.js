...
- If the assistant's immediately preceding message was asking the user to provide a specific
  piece of search criteria (location, budget, bedrooms, property type, furnishing, timeline,
  purpose), then the user's reply is PROPERTY_SEARCH even if it is just a single word, a number,
  or a place/area name with no other context (e.g. bot asks "What location?" and user replies
  "Camp" — that is PROPERTY_SEARCH, not GENERAL_FAQ, even though "Camp" is also a real locality
  that could otherwise come up in an area-info question).
- Phrases that signal the user wants to abandon their current search and begin a genuinely
  different one — "I want to start over", "my requirements have changed", "forget what I said
  before", "actually let's start fresh" — are PROPERTY_SEARCH, not SMALL_TALK, GENERAL_FAQ, or
  OTHER, even when no new concrete criteria (budget/location/type) is given in that same message.
- A message that switches the stated property type, purpose, or transaction type from what was
  discussed earlier (e.g. was asking about an Apartment, now says "Villa"; was Residential, now
  says "Commercial"/"Office"; was Rent, now says "Buy"/"Sale") is always PROPERTY_SEARCH.`;
